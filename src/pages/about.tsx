							...
							<Row gutter={24} type="flex" align="middle">
								...
								<Col xs={24} sm={24} md={24} lg={12} xl={10} xxl={8}>
									<div className="description-wrapper">
										<h2 className="text-uppercase">Antonio Müller</h2>
										<p className="text-bold text-uppercase">Full Stack Developer / Entrepeneur</p>
										<p>15+ years in working with many technologies.</p>
										<div className="description">
											...
											<p className="margin-bottom-12px">
												...
												<span className="label">contato@antonimuller.com</span>
											</p>
											<p>
												<span className="icon"><Icon type="pushpin" /></span>
												<span className="label">Rio de Janeiro, Brazil</span>
											</p>
										</div>
									</div>
								</Col>
